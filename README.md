...
This tool was created by Dr. Camden Bay (biostatistics) and encompasses the CT-based body composition data provided in Magudia et al 2021 (citation below). It was subsequently modified by Zhiwei Liang to provide race-agnostic options. This tool will accept a list of body composition areas, including skeletal muscle area, subcutaneous fat area, and visceral fat area, plus subject demographics (age at measurement, sex, and optional race) and return population-indexed normative values. These values are currently returned in the form of z-scores.  
...
This version of the model allows selection of race-specific or race-agnostic reference models to calculate z-scores. The suitablity of each model for any task will depend upon the alignment of the sample population with the reference population from this study. 
